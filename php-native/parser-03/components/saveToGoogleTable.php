...
define('SPREAD_SHEET_ID', 'YOUR_SHEET_ID');
...
function readGoogleSheet()
{
    try {
        ...
        setLog('Something went wrong: Failed to read into table' . $th, 'p');
        echo "Something went wrong: Failed to read into table\n" . $th . "\n";
    }
...
function writeGoogleSheet($data, $sheetIndex, $sheetTitle, $rowIndex, $category)
{
    try {
        ...
        setLog('Something went wrong: Failed to write to table' . $th, 'p');
        echo "Something went wrong: Failed to write to table\n" . $th . "\n";
    }
